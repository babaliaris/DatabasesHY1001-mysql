...
/*
These views can be used to retrieve information per production for statistic purposes.
For example the frontend could compare two productions wheat total weight and tell the user
which production has the higher weight value.
*/

DROP VIEW IF EXISTS view_farmers_incomes_outcomes_per_production;

-- Get farmers all related incomes and outcomes per production.
...
-- Get the total weight of wheat per production.
...
-- Get the total weight of olives per production.
